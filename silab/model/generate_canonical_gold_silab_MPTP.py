...
OUTPUT_FILE = SCRIPT_DIR / f"canonical_gold_qas_{MODEL_SLUG}_MPTP.json"
FILTERED_LOG = SCRIPT_DIR / f"filtered_verses_{MODEL_SLUG}_MPTP.json"
LOG_FILE = SCRIPT_DIR / f"generation_log_{MODEL_SLUG}_MPTP.jsonl"
