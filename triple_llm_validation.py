...
LOG_FILE = "validation_log_3models.jsonl"
OUTPUT_MAJORITY = "gold_majority_supported.json"
OUTPUT_STRICT = "gold_strict_supported.json"
...
for i, entry in enumerate(gold_data):
    if 'question' not in entry:
        print("Missing question at index:", i)
        print(entry)
        break
